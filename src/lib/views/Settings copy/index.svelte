...
<div class="grid">
    ...
    <div class="dataSection">
      <LabeledItem label="Email">
        <div class="item">
          ...
          <Button on:click={() => showChangeAttributesScreen(["email"])}>
            <EditIcon size="1.5" />
          </Button>
        </div>
      ...
      <LabeledItem label="Phone Number">
        <div class="item">
          ...
          <div class="icons">
            ...
            <Button on:click={() => removeAttribute("phone_number")}>
  ...
  <div class="dataSection">
    ...
    {#if $isSignedIn && $user}
      <Button isDisabled={$loadingAuthEvent} on:click={signOut}
        >Sign Out
      </Button>
      <Button isDisabled={$loadingAuthEvent} on:click={() => signOut(true)}
